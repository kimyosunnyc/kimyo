	...
	function etheme_VS_setup() {
	    ...
	    $fpost_params = array(
	      ...
	      'params' => array(
			...
			array(
	          "type" => "dropdown",
	          "heading" => __("Sorting", ETHEME_DOMAIN),
	          "param_name" => "orderby",
	          "value" => array( __("ASC", ETHEME_DOMAIN), __("DESC", ETHEME_DOMAIN) )
	        ),
	        array(
	          "type" => "dropdown",
	          "heading" => __("Sorting Type", ETHEME_DOMAIN),
	          "param_name" => "order",
	          "value" => array( __("Menu order", ETHEME_DOMAIN)=> 'menu_order', __("Name", ETHEME_DOMAIN) => 'name', __("ID", ETHEME_DOMAIN)=> 'ID')
	        ),
	        array(
	          "type" => "dropdown",
	          "heading" => __("Display Type", ETHEME_DOMAIN),
